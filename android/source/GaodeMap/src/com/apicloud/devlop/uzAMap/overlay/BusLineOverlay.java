...
public class BusLineOverlay {
    ...
    protected BitmapDescriptor getStartBitmapDescriptor() {
        startBit = BitmapDescriptorFactory.fromResource(UZResourcesIDFinder.getResDrawableID("amap_start"));
        return startBit;
    }

    protected BitmapDescriptor getEndBitmapDescriptor() {
        endBit = BitmapDescriptorFactory.fromResource(UZResourcesIDFinder.getResDrawableID("amap_end"));
        return endBit;
    }

    protected BitmapDescriptor getBusBitmapDescriptor() {
        busBit = BitmapDescriptorFactory.fromResource(UZResourcesIDFinder.getResDrawableID("amap_bus"));
        return busBit;
    }
