...
public class RouteOverlay {
	...
	protected BitmapDescriptor getStartBitmapDescriptor() {
		return BitmapDescriptorFactory.fromResource(getDrawID("amap_start"));
	}
	/**
	...
	protected BitmapDescriptor getEndBitmapDescriptor() {
		return BitmapDescriptorFactory.fromResource(getDrawID("amap_end"));
	}
	/**
	...
	protected BitmapDescriptor getBusBitmapDescriptor() {
		return BitmapDescriptorFactory.fromResource(getDrawID("amap_bus"));
	}
	/**
	...
	protected BitmapDescriptor getWalkBitmapDescriptor() {
		return BitmapDescriptorFactory.fromResource(getDrawID("amap_man"));
	}
	...
	private int getDrawID(String resName) {
